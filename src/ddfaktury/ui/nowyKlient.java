...
public class nowyKlient extends javax.swing.JDialog {
    boolean ostrzezenie;
    boolean blad1,blad2,blad3,blad4,blad5;

    public nowyKlient(java.awt.Frame parent, int id) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ddfaktury.ui.DdFakturyApp.class).getContext().getResourceMap(nowyKlient.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ddfaktury.ui.DdFakturyApp.class).getContext().getActionMap(nowyKlient.class, this);
